...
public class BasicComponentBuilder {
	...
	public JComboBox<Desarrolladores> construirCombo(
			Desarrolladores[] opciones, int posX, int posY) {

		JComboBox<Desarrolladores> combo = new JComboBox<Desarrolladores>(
				opciones);
		Border border = LineBorder.createGrayLineBorder();
